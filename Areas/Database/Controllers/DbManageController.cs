...
namespace appmvcnet.Areas.Database.Controllers
{
    ...
    public class DbManageController : Controller
    {
        ...
        public async Task<IActionResult> DeleteDbAsync()
        {
            ...
            StatusMessage = success ? "Deleting db succeeded" : "Failed to delete db";
        ...
        public async Task<IActionResult> Migrate()
        {
            ...
            StatusMessage = "Updating db succeeded";
        ...
        public async Task<IActionResult> SeedDataAsync()
        {
            ...
            StatusMessage = "Seeding data succeeded";
        ...
        private void SeedProductCategory()
        {
            ...
            int cm = 1;
            fakerCategory.RuleFor(c => c.Title, fk => $"Product category{cm++} " + fk.Lorem.Sentence(1, 2).Trim('.'));
